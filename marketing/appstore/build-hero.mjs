...
const PANELS = [
  {
    id: '01',
    kicker: 'FOOTBALL DYNASTY SIM',
    white: 'Manage any',
    accent: 'club.',
    sub: 'Sign. Scout. Win. Leave a legacy.',
  ...
  {
    id: '02',
    kicker: 'MINUTE-BY-MINUTE MATCHES',
    white: 'Feel every',
    accent: 'minute.',
    sub: 'Live commentary. Tactical calls. Real drama.',
  ...
  {
    id: '03',
    kicker: 'BUILD THE PERFECT XI',
    white: 'Collect gold',
    accent: 'legends.',
    sub: 'Real stats. Real ratings. Walkout cards.',
  ...
  {
    id: '04',
    kicker: 'A DEEP TRANSFER MARKET',
    white: 'Own the',
    accent: 'market.',
    sub: 'Scout, bid and steal the deal of the season.',
  ...
  {
    id: '05',
    kicker: 'CLUB AND COUNTRY',
    white: 'Lead your',
    accent: 'nation.',
    sub: 'Take your country all the way to the World Cup.',
    hero: SRC.nation, left: SRC.tactics, right: SRC.dynasty,
    pills: { gold: 'WORLD CUP CALL-UP', glass: '51 national teams' },
