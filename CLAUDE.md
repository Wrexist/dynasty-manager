...
- **Vitest 3.2.4 + jsdom + Testing Library** — 249 test files in `src/test/`
...
├── test/                → 249 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (249 test files)
