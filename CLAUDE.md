...
- **Vitest 3.2.4 + jsdom + Testing Library** — 243 test files in `src/test/`
...
├── test/                → 243 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (243 test files)
