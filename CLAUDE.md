...
- **Vitest 3.2.4 + jsdom + Testing Library** — 233 test files in `src/test/`
...
├── test/                → 233 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (233 test files)
