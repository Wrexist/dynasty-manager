...
- **Vitest 3.2.4 + jsdom + Testing Library** — 227 test files in `src/test/`
...
├── test/                → 227 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (227 test files)
