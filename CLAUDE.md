...
- **Vitest 3.2.4 + jsdom + Testing Library** — 251 test files in `src/test/`
...
├── test/                → 251 test files incl. longevity/stress suites, adversarial
...
2. **`src/store/storeTypes.ts`** — complete `GameState` interface (713 LOC).
...
npm run test         # Vitest (251 test files)
