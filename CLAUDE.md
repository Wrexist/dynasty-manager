...
- **Vitest 3.2.4 + jsdom + Testing Library** — 246 test files in `src/test/`
...
├── test/                → 246 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (246 test files)
