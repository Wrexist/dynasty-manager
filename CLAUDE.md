...
- **Vitest 3.2.4 + jsdom + Testing Library** — 222 test files in `src/test/`
...
├── test/                → 222 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (222 test files)
