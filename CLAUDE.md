...
- **Vitest 3.2.4 + jsdom + Testing Library** — 238 test files in `src/test/`
...
├── test/                → 238 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (238 test files)
