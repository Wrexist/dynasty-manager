...
- **Vitest 3.2.4 + jsdom + Testing Library** — 209 test files in `src/test/`
...
2. **`src/store/storeTypes.ts`** — complete `GameState` interface (693 LOC).
...
npm run test         # Vitest (209 test files)
