...
- **Vitest 3.2.4 + jsdom + Testing Library** — 223 test files in `src/test/`
...
├── test/                → 223 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (223 test files)
