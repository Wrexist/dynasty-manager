...
- **Vitest 3.2.4 + jsdom + Testing Library** — 247 test files in `src/test/`
...
├── test/                → 247 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (247 test files)
