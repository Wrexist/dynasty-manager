...
- **Vitest 3.2.4 + jsdom + Testing Library** — 231 test files in `src/test/`
...
├── test/                → 231 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (231 test files)
