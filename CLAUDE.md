...
- **Vitest 3.2.4 + jsdom + Testing Library** — 242 test files in `src/test/`
...
├── test/                → 242 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (242 test files)
