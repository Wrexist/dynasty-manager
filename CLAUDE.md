...
- **Vitest 3.2.4 + jsdom + Testing Library** — 265 test files in `src/test/`
...
├── test/                → 265 test files incl. longevity/stress suites, adversarial
...
npm run test         # Vitest (265 test files)
