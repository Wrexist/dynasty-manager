...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    build: null,
    date: '2026-08-28',
    headline: 'The Market is rebuilt: one free pack a day that improves with your login streak, a featured pack each week with a bonus card, and published drop rates on every pack.',
    summary: 'The Market is rebuilt: one free pack a day that improves with your login streak, a featured pack each week with a bonus card, and published drop rates on every pack. Packs now tear open down the side like a real foil booster — the rip travels down the seam and the wrapper peels away. Plus 2 more highlights, 3 new features, 4 improvements, and 2 fixes across the rest of the build.',
    highlights: [
    ...
    fixed: [
      ...
      'Existing saves now get the eased wage curve too — squads carried over from an older save were still paying the old rates.',
    ],
  },
  {
    version: '1.5.0',
