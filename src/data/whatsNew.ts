...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    build: null,
    date: '2026-09-20',
    headline: 'Build your squad. Make your dynasty.',
    summary: 'Bronze, Silver, Gold and premium packs stay in the Market, with rotating bonus offers, clear contents and live countdowns. This update also brings Hall of Legends cards, refreshed player data and stronger save and purchase recovery.',
    highlights: [
      'Bronze and Silver each offer a free pack daily, alongside the Daily Pack that improves with your login streak.',
      'Gold, Elite, World Class and Legends packs stay available, with rotating bonus-card offers at the usual store price.',
      'Hall of Legends brings retired greats into Elite, World Class and Legends packs, including stars who retire in your own save.',
    ],
    new: [
      'Cover-led pack offers show player counts, guaranteed ratings and time remaining.',
      'Choose a pack to review its contents and odds, then buy from the same screen.',
      'Player profiles highlight breakthrough development and career milestones.',
    ],
    improved: [
      'Updated player data and full player names, with improved card backs and pack reveals.',
      'Pack wages and quick-sell returns better fit your club economy.',
      'The Market shows localized store prices and the best live bonus for each pack.',
    ],
    fixed: [
      'Interrupted paid packs retain their bonus cards and weekly edition during recovery.',
      'Save confirmations wait for storage, and failed saves keep an accurate status.',
      'Quick-sell Undo no longer overwrites later actions.',
      'Fixed the Daily Reward close button and duplicate nationality choices.',
    ],
  },
  {
    version: '1.5.0',
    build: null,
    date: '2026-08-23',
    headline: 'Injuries across the rest of the world now heal. Previously only your own squad recovered, so by season three most of the league was permanently injured — which is also why your fixtures could quietly go unplayed.',
    summary: 'Injuries across the rest of the world now heal. Previously only your own squad recovered, so by season three most of the league was permanently injured — which is also why your fixtures could quietly go unplayed. V1.4.0: Fix critical save, training, and monetization regressions. Plus 7 improvements and 8 fixes across the rest of the build.',
    highlights: [
