...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    build: null,
    date: '2026-08-06',
    headline: 'Every league, every playoff, every match — played for real.',
    summary: 'Rival clubs now field their best available team and develop season after season, so tables, promotion races and scoring charts mean what they say — and the squad you build decides your results. Promotion playoffs are played out as real matches with your club in them, half-time team talks last the whole second half, and penalty shootouts are yours to take. Plus a smaller download and dozens of fixes, from the title screen that could hang after an update to Dynasty Pro being revoked from paying subscribers.',
    highlights: [
      ...
      'Promotion playoffs are played out as real matches instead of being decided behind the scenes, and you play your own.',
    ],
    new: [
    ...
    improved: [
      'Matches look like football: far fewer shots on target, close to ten corners a game, and keeper errors that count as real chances.',
      'Players at every club in the world now develop season after season, so the game world grows and ages around you instead of standing still.',
      ...
      'Upgrading the Medical Centre now genuinely reduces the injuries you pick up in matches.',
      ...
      'The app is around 35 MB smaller to download and update.',
      'Dynasty Pro prices and free-trial eligibility now come straight from the App Store, so what you are shown is what your store actually offers.',
    ],
    fixed: [
      'Fixed the title screen hanging with no Continue and no New Game after an app update.',
      'Fixed Dynasty Pro being taken away from paying subscribers when loading an older save.',
      'Fixed half-time team talks wearing off after about fifteen minutes instead of lasting the second half.',
      'Fixed third place being promoted automatically in Spain, Italy, Germany and France without a playoff.',
      'Fixed season rollover faults where a club could be promoted and relegated in the same summer, your own results could be re-simulated, and last season\'s playoff bracket could replay.',
      'Fixed goals being scored after a match had already been abandoned.',
      ...
      'Fixed match reviews reporting the wrong result after a penalty shootout.',
      'Cancelling a purchase no longer shows a purchase-failed error.',
      'The Shop no longer offers items your store cannot actually sell.',
      'Dynasty Pro plans now load reliably at checkout, with a clear retry if the App Store cannot be reached.',
