              ...
              return (
                <div key={p.id} className="flex flex-col items-center gap-2">
                  <div className="relative" style={{ width: PLAYER_CARD_SIZE_PX.lg }}>
                    ...
                    />
                    {/* Upgrade badge — only appears in summary, only when the
                        pulled player out-rates the user's current best at the
                        same position. Springs in slightly after the card so
                        the eye reads card → "and it's an upgrade!" rather
                        than both at once. Gold gradient so it echoes the
                        Sell button + Guarantee Tracker visual language. */}
