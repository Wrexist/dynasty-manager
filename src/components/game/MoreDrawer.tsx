...
import {
  ...
  Settings, MoreHorizontal, ChevronRight, ChevronDown, GitCompare, User, Star, Award, ShoppingBag, Crown, HelpCircle, Globe, Briefcase, Search, Medal, Ticket
} from 'lucide-react';
...
const drawerSections: DrawerSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { screen: 'season-pass', label: 'Dynasty Pass', icon: Ticket, description: 'Free season-long reward track' },
