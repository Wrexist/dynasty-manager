...
import {
  ...
  Dumbbell, UserCog, Sprout, Users, Package, ArrowLeftRight, Ticket
} from 'lucide-react';
...
const drawerSections: DrawerSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { screen: 'manager-pass', label: 'Manager Pass', icon: Ticket, description: 'Season rewards: free + Pro track' },
