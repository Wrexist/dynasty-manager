...
import { PENALTY_CONVERSION_RATE, SHOUT_MODIFIERS, SHOUT_CUMULATIVE_SCALE, GOAL_EVENT_TYPES, NATIONAL_OVR_STR_MIN, NATIONAL_OVR_STR_MAX, NATIONAL_OVR_STR_FLOOR, NATIONAL_OVR_STR_RANGE } from '@/config/matchEngine';
