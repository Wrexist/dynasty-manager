...
export const MANAGER_PERKS: ManagerPerk[] = [
  ...
  { id: 'set_piece_coach', name: 'Set Piece Coach', description: 'Set piece goals +15% more likely', icon: 'target', cost: 100, tier: 1, branch: 'tactician', row: 0 },
  ...
  { id: 'motivator', name: 'Motivator', description: 'Pre-match team talks give +5 morale boost', icon: 'megaphone', cost: 100, tier: 1, branch: 'motivator', row: 0 },
  ...
  { id: 'scout_network', name: 'Scout Network', description: 'Scouting assignments complete 1 week faster', icon: 'search', cost: 100, tier: 1, branch: 'dealmaker', row: 0 },
  ...
  { id: 'fitness_guru', name: 'Fitness Guru', description: 'Reduce injury risk by 20% during training', icon: 'dumbbell', cost: 100, tier: 1, branch: 'developer', row: 0 },
