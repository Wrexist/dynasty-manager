          ...
          <GlassPanel className="p-4">
            ...
            <div className="flex items-center justify-between text-[10px] text-muted-foreground">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[hsl(var(--silver))]">{silverDone} silver</span>
                <span className="text-[hsl(var(--bronze))]">{bronzeDone} bronze</span>
              </div>
            </div>
          </GlassPanel>
        );
      ...
      {leagueCupWins > 0 && (
        <GlassPanel className="p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs text-cyan-400 font-bold ml-auto">{leagueCupWins}</span>
          </div>
          <div className="grid grid-cols-4 gap-2">
      ...
      {conferenceCupWins > 0 && (
        <GlassPanel className="p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs text-emerald-400 font-bold ml-auto">{conferenceCupWins}</span>
          </div>
          <div className="grid grid-cols-4 gap-2">
