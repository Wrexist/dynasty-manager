...
createRoot(document.getElementById('root')!).render(<main style={{padding:32,maxWidth:1400,margin:'auto'}}>
  ...
  <h1 style={{fontSize:40,fontWeight:800,margin:'12px 0'}}>Premier League · Batch 02</h1>
  <p style={{color:'#adbdb6',marginBottom:24}}>25 new transparent portraits · Actual PlayerCard component · Ratings from the checked-in game roster · Tap a card to cycle its views.</p>
