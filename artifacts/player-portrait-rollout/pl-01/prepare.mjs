...
const out='public/player-portraits/pl-01';fs.mkdirSync(out,{recursive:true});
...
try{
 ...
 const r=await page.evaluate(async slug=>{
  const img=new Image();img.src='/artifacts/player-portrait-rollout/pl-01/sources/'+slug+'.png';await img.decode();
 ...
 fs.writeFileSync('artifacts/player-portrait-rollout/pl-01/validation.json',JSON.stringify(report,null,2));
